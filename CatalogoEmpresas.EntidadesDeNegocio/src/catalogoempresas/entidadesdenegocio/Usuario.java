...
public class Usuario {
    ...
    public Usuario(int id, int idRol, String nombre, String apellido, String login, String password, byte status, LocalDate fechaRegistro, int top_aux, String confirmPassword_aux, Rol Rol) {
        this.id = id;
        this.idRol = idRol;
        this.nombre = nombre;
